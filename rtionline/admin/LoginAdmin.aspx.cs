...
using System.Data;
public partial class LoginAdmin : BasePage // System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (GV_Department.Visible == true)
            {
                lbl_count.Visible = true;
                BindDepartmentView();
            }
            else if (GV_MapEmp.Visible == true) {
                lbl_count.Visible = true;
                BindMapEmpView();
            }
            else if (GV_Office.Visible == true)
            {
                lbl_count.Visible = true;
                BindOfficeView();
            }
    ...
    protected void BindMapEmpView()
    {
        ...
        if (Session["language"].ToString() == "en-GB")
        {
            lbl_count.Text = "Total Mapped Employee = " + row.ToString() + "  and  Total page = " + page.ToString() + "";
        }
        else
        {
