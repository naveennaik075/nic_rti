    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="panel-title">
               <%=Resources.Resource.RollAddingForm %> 
            </div>
        </div>
        <div class="panel-body">
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="col-sm-4">
                          <asp:Label ID="Label1" Text="<%$Resources:Resource, RoleName %>" runat="server"></asp:Label><span class="text-danger">*</span>
                       
                        <asp:TextBox ID="txt_role_name" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfv_rollname" ControlToValidate="txt_role_name" ValidationGroup="vg" CssClass="alert-danger" runat="server" ErrorMessage="required"></asp:RequiredFieldValidator>
                    </div>

                    <div class="col-sm-4">
                          <asp:Label ID="Label2" Text="<%$Resources:Resource, Active %>" runat="server"></asp:Label><span class="text-danger">*</span>
                        ...
                        <asp:RequiredFieldValidator ID="rfv_ddl" ControlToValidate="ddl_active" ValidationGroup="vg" CssClass="alert-danger" InitialValue="0" runat="server" ErrorMessage="required"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-sm-4">
                            <asp:Label ID="Label3" Text="<%$Resources:Resource, WelcomePage %> " runat="server"></asp:Label> 

                       
                        <asp:TextBox ID="txt_de_page" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfv_welcomepg" ControlToValidate="txt_de_page" ValidationGroup="vg" CssClass="alert-danger" runat="server" ErrorMessage="required"></asp:RequiredFieldValidator>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <asp:Button ID="btn_save" CssClass="button button-3d button-black nomargin" ValidationGroup="vg" OnClick="btn_save_Click" runat="server" Text="<%$Resources:Resource, Save %>" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-12">
                ...
                <asp:GridView ID="grd_Office" runat="server" AllowPaging="true" PageSize="20" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="<%$Resources:Resource, RoleName %>" DataField="RoleName">
                            <ItemStyle HorizontalAlign="left" />
                            <HeaderStyle HorizontalAlign="left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="WelcomePage" HeaderText="<%$Resources:Resource, WelcomePage %> ">
                            <ItemStyle HorizontalAlign="left" />
                            <HeaderStyle HorizontalAlign="left" />
                        </asp:BoundField>
