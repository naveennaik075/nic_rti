...
public partial class dio_Create_Office : BasePage  // System.Web.UI.Page
{
            ...
            else
            {
                ...
                if (rd.table.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Utilities.MessageBox_UpdatePanel_Redirect(udp, "आप कार्यालय जोड़ने के लिए अधिकृत नहीं हैं|", "../admin/loginAdmin.aspx");
        ...
        if (Session["CheckRefresh"].ToString() == ViewState["CheckRefresh"].ToString())
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (rb.status == true)
                {
                    ...
                    {
                        Utilities.MessageBox_UpdatePanel(udp, "ऑफिस सृजन सफल");
                ...
                else
                {
                    if (Session["language"].ToString() == "en-GB")
                    {
                        ...
                        Utilities.MessageBox_UpdatePanel(udp, "OFFICE CREATION UNSUCCESFUL");
                    }
                    else
                    {
                        Utilities.MessageBox_UpdatePanel(udp, "ऑफिस सृजन असफल");
