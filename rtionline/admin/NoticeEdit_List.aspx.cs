...
public partial class Admin_NoticeEdit_List :  BasePage // System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
         ...
         //   bind_GridView();    // commented by Naveen on 30-Aug-2017

        }
        bind_GridView();            // Added by Naveen on 30-Aug-2017
    }
    ...
    public void bind_GridView()
    {
        ...
        dt = dl.Get_NoticeRecords_For_Edit(bl);
        ...
        {
            lbl_count.Text = "कुल सुचना = " + row.ToString() + "  और  कुल पेज = " + page.ToString() + "";
        }
