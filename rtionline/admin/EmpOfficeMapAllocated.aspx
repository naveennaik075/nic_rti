        ...
        <div class="panel-collapse panel panel-default">
            <div class="panel-heading">
                ...
                <h5 class="panel-title">
                    <b>
                        <asp:Label ID="lbl_outer_panel" runat="server" Text="<%$Resources:Resource, EmployeeOfficeMappingAllocated %> "></asp:Label>
                    </b>
                </h5>
                <div>
    ...
    <div class="panel-default">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <asp:Label ID="lbl_office_Category1" runat="server" Text="<%$Resources:Resource, OfficeCategory %>"></asp:Label>
                                <span class="text-danger">*</span>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <asp:RequiredFieldValidator ID="rfv_office_category1" runat="server" ControlToValidate="ddl_office_Category1" CssClass="alert-danger" Display="Dynamic" ErrorMessage=" Please Enter Office Category" SetFocusOnError="true" ValidationGroup="vg" InitialValue="0"></asp:RequiredFieldValidator>
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-sm-2">
                                <asp:Label ID="lbl_office_level1" runat="server" Text="<%$Resources:Resource, OfficeLevel %>"></asp:Label>
                                <span class="text-danger">*</span>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-2">
                                ...
                                <asp:Label ID="lbl_office_name1" runat="server" Text="<%$Resources:Resource, OfficeName %>"></asp:Label>
                                <span class="text-danger">*</span>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <div class="col-sm-2">
                                ...
                                <asp:Label ID="lbl_designation1" runat="server" Text="<%$Resources:Resource, DesignationName %>"></asp:Label>
                                <span class="text-danger">*</span>
                            </div>
                            <div class="col-sm-4">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="form-group">
                    <div class="col-sm-2">
                        <label class="text-primary"><%=Resources.Resource.SelectPermissions %></label>
                    </div>
                    <div class="col-sm-4">
