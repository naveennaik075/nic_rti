<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Notice_Entry.aspx.cs" Inherits="admin_notice_entry" MasterPageFile="~/admin_master.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_MasterLogin" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            $(".dd").addClass("form-control");  // This line is not required
            try {
        ...
        $(function () {
            $('#CPH_MasterLogin_ddlimage').change(function () {
                ...
                if (selectedText == "Select") {
                    ...
                    //changed by naveen on 01-09-2017
                   <%-- var ra2 = document.getElementById('<%=RFV_Image_Icon.ClientID %>');
                    ra2.ValidationGroup = "a";
                    ValidatorEnable(ra2, true);--%>
                }
                else {
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading text-center">
                <h3 class="panel-title"><%=Resources.Resource.NoticeEntryForm %></h3>
            </div>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <asp:Label ID="lblChar" runat="server" ForeColor="Maroon"><%=Resources.Resource.CharRemain %> </asp:Label>
                    ...
                    <div class="form-group">
                        ...
                        <div id="divFileUpload" class="col-sm-4" style="display: none">
                        ...
                        <div id="divUrl" class="col-sm-4" style="display: none">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <label><%=Resources.Resource.SelectImage %> <span class="text-danger">*</span> </label>
                            <asp:DropDownList ID="ddlimage" runat="server" CssClass="form-control mydds "  >
                               <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RFV_Image_Icon" runat="server" ControlToValidate="ddlimage" SetFocusOnError="true"
                                ErrorMessage="required" ForeColor="#FF3300" Font-Size="Large" InitialValue="0" Font-Bold="true" ValidationGroup="a">
                            </asp:RequiredFieldValidator>
            ...
            <div class="form-group" style="padding-left: 650px;">
                ...
                <asp:Button ID="btnSubmit" runat="server" Text="<%$Resources:Resource, Submit %>" OnClick="btnSubmit_Click" CssClass="button button-large button-dark button-rounded" ValidationGroup="a" />
            </div>
