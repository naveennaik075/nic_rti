<%@ Page Title="" Language="C#" MasterPageFile="~/admin_master.master" AutoEventWireup="true"
    CodeFile="NoticeEdit_List.aspx.cs" Inherits="Admin_NoticeEdit_List" %>
        ...
        <asp:UpdatePanel ID="udp" runat="server">
                ...
                <div class="form-horizontal">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><%=Resources.Resource.NoticeBoard %>
            ...
            <HeaderStyle />
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered  table-hover table-grid"
                        ...
                        EmptyDataText="No Record Found." OnRowDataBound="GridView1_RowDataBound" datakeys="notice_id" DataKeyNames="Notice_Id,File_Id">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="<%$Resources:Resource, Edit %>">
                                <ItemTemplate>
