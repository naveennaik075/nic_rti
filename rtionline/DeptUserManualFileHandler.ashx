<%@ WebHandler Language="C#" Class="DeptUserManualFileHandler" %>

using System;
using System.Web;

public class DeptUserManualFileHandler : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        ReturnClass.ReturnDataTable dt = objDL.GetDataForDeptManualHandler(fid_str);
